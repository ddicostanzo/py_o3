...
class AttributeToSQLColumn:
    def __init__(self, attribute: O3Attribute, allow_phi_flag: bool, sql_server_type: SupportedSQLServers):
    ...
    def column_creation_text(self):
        return f'{self.column_name} {self.column_data_type(self.sql_server)} {self.column_nullable}'
